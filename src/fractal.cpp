...
const std::vector<std::string>& Fractal::getUniformNames() const { return uniformNames; }
...
void Fractal::setUniformValue(const std::string& name, float value) { uniforms[name] = value; }
