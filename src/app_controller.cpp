...
AppController::AppController()
    : camera(), cameraController(camera), sceneRenderer(nullptr), uiManager(nullptr) {
    init();
}
...
void AppController::processInput() { glfwManager.processInput(cameraController); }

void AppController::endFrame() { glfwManager.endLoop(); }
